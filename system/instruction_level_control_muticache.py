...
修改pass为 InjectPass_profiling_multicache
python3 system/instruction_level_control.py
'''
# 获取该APP的信息
app_name = "convolutionSeparable_hip"
kernel_name = ["_Z9conv_rowsPfPKfS1_iii"] # 考虑一个应用有多个kernel
...
log_name = "./system/muti_cache_result/%s.txt" % app_name
...
for kernel in kernel_name:
    ...
    ## 得到loads的bypass策略
    bypass_policy = global_loads_bypass_algorithm(groups, loads)
