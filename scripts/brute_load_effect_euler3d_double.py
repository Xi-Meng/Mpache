...
load_all="%17 %22 %24 %32 %34 %41 %43 %51 %53 %61 %63"
app_name = "euler3d_double"
...
## 运行-----------------------------------------
cache_time = 0
cmd = f"./bin/{app_name}/{app_name}_{load} /workspace/Inst-level-cache-management/include/cfd/data/missile.domn.0.2M"
