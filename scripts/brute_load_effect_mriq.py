...
## 运行-----------------------------------------
cache_time = 0
cmd = f"./bin/{app_name}/{app_name}_{load} -i /workspace/Inst-level-cache-management/include/mriq_parboil/data/small/input/32_32_32_dataset.bin"
