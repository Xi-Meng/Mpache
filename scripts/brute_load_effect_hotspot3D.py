...
load_all="%49 %53 %57 %62 %67 %72 %80 %107 %112 %117 %122 %128 %145 %149 %154 %159 %164 %173"
app_name = "hotspot3D"
...
## 运行-----------------------------------------
cache_time = 0
cmd = f"./bin/{app_name}/{app_name}_{load} 64 8 100 ./include/hotspot3D/data/power_64x8 ./include/hotspot3D/data/temp_64x8 output.out"
