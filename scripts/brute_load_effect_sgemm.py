...
load_all="%50 %60 %70 %80 %90 %100 %110 %120 %130 %140 %150 %160 %170 %180 %190 %200 %213 %218 %288 %342 %396 %450 %504 %558 %612"
app_name = "sgemm"
...
## 运行-----------------------------------------
cache_time = 0
cmd = f"./bin/{app_name}/{app_name}_{load} -i /workspace/Inst-level-cache-management/include/sgemm/data/medium/input/matrix1.txt,/workspace/Inst-level-cache-management/include/sgemm/data/medium/input/matrix2t.txt,/workspace/Inst-level-cache-management/include/sgemm/data/medium/input/matrix2t.txt"
