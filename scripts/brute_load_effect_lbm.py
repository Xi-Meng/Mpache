...
load_all="%12 %16 %20 %24 %28 %32 %36 %40 %44 %48 %52 %56 %60 %64 %68 %72 %76 %80 %84 %88"
app_name = "lbm_main"
...
## 运行-----------------------------------------
cache_time = 0
cmd = f"./bin/{app_name}/{app_name}_{load} -i /workspace/Inst-level-cache-management/include/lbm_main/data/long/input/120_120_150_ldc.of -o /workspace/Inst-level-cache-management/include/lbm_main/data/temp.txt -- 3000"
