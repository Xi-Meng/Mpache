...
# 在文件中写入矩阵元数据
file_name = '/workspace/Inst-level-cache-management/include/spmv_my/dataset/demo_vector.mtx'
n_rows, n_cols = args.rows, 1
...
# n_rows, n_cols, n_elements = 11500, 11500, 5000000
n_rows = args.rows
n_cols = args.cols
n_elements = args.elements
file_name='/workspace/Inst-level-cache-management/include/spmv_my/dataset/demo_matrix.mtx'
# 打开一个文件并写入矩阵元数据
with open(file_name, 'w') as f:
